...
sprites.onOverlap(SpriteKind.Projectile, SpriteKind.Enemy, function (sprite, otherSprite) {
    malo.destroy(effects.confetti, 200)
...
carro = sprites.create(img`
    ...
    . . . . b b f . . . . b b f . . 
    `, SpriteKind.Player)
carro.setStayInScreen(true)
let bala = sprites.create(img`
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    ...
    . . . . . . . . . . . . . . . . 
    `, SpriteKind.Food)
bala.setVelocity(45, 45)
bala.setStayInScreen(true)
bala.setBounceOnWall(true)
...
forever(function () {
    malo = sprites.create(img`
        ...
        ........................
        `, SpriteKind.Enemy)
    malo.setPosition(0, randint(0, 120))
    malo.setVelocity(60, 0)
    pause(3000)
})
forever(function () {
